...
\begin{minipage}[b]{75cm}
  ...
  \begin{center}
    ...
    \includegraphics[width=75cm,trim= 0cm 0cm 0cm 2cm, clip]{gfx/cassini_52_lr.pdf}
    \label{GIS-based map}
    \vfill
  \end{center}
\end{minipage}
 ...
 \begin{tikzpicture}[remember picture, overlay]
      \node[anchor=north west] at (0,7.5){%
        \includegraphics[width=61cm]{gfx/maplegend.png}};
\end{tikzpicture}
...
\begin{tabular}{@{}lcccc@{}}
\toprule
                & \multicolumn{2}{c}{Cassini's coordinates ('toises')}                                                & \multicolumn{2}{c}{WGS84 coordinates (degrees)}              \\ \midrule
                & \multicolumn{1}{l}{Distance to the central meridian} & \multicolumn{1}{l}{... to the perpendicular} & \multicolumn{1}{l}{Latitude} & \multicolumn{1}{l}{Longitude} \\
top left corner & 20$\sim$000                                          & 162$\sim$500                                 & 45°59'9.98''N                & 2°52'23.60''E                 \\
top right       & 60$\sim$000                                          & 162$\sim$500                                 & 45°58'39.6''N                & 3°50'48.22''E                 \\
lower-left      & 20$\sim$000                                          & 187$\sim$500                                 & 45°32'52.36''N               & 2°50'9.38''E                  \\
lower-right     & 60$\sim$000                                          & 187$\sim$500                                 & 45°32'21.11''N               & 3°20'03.97''E                 \\ \bottomrule
\end{tabular}
\caption{Full map footprint}
\label{my-label}
\end{table}
...
& \multicolumn{8}{c|}{$\overbrace{        }{Landscape feature}$}
& 
