...
\begin{minipage}[b]{\textwidth}
  \setlength{\parindent}{-0em}
  \begin{multicols}{3}
    \section*{\normalfont B. \textsc{Duménieu}\up{a}, J. \textsc{Chadeyron}\up{b}, P. \textsc{Cristofoli}\up{a}, J. \textsc{Perret}\up{a,c} and S. \textsc{Baciocchi}\up{a},\newline in collaboration with S. Gomis, M. Gribaudi, I. Langlois, C. Motte and M.-C. Vouloir}
    ...
    \vfill
    \small
    \up{a} EHESS, CRH, bertrand.dumenieu@ehess.fr, stephane.baciocchi@ehess.fr, pascal.cristofoli@ehess.fr; \up{b} University of Clermont-Ferrand (UCA), julien.chadeyron@uca.fr; \up{c} Univ. Paris-Est, LASTIG STRUDEL, IGN, ENSG, julien.perret@ign.fr
    \vfill
...
\begin{minipage}[b]{\textwidth}
  ...
  \begin{multicols}{3}
    ...
    \begin{center}
      \captionsetup{type=figure}
      \caption{Successive drafts of field surveys, map corrections and reviews (1759-1775)}
      \label{map:contours}
      \includegraphics[width=0.26\textwidth,trim= 0cm 0cm 0cm 0cm, clip]{gfx/Contours}
    \end{center}
%~\\
    \normalsize
    %\textsc{From antique to renewed GIS-based historical map}
    ...
    \begin{center}
     \captionsetup{type=figure}
      \caption{Vector geographic data extracted from the digitized and georeferenced original map (a) is arranged into GIS layers and composed to build the renewed version of the Cassini's \textit{Carte de France}. Subfigures (b), (c) and (d) show an overview of the 15-layers composition that results in the final rendering à la Cassini (e).}
      \includegraphics[width=0.28\textwidth]{gfx/mapmaking}
    \end{center}    
    %\begin{center}
     %\captionsetup{type=table}
     % \caption{Colours in the renewed map differ slightly from the original map to improve the overall readability, while remaining close to the Cassini style.}
     % \includegraphics[width=0.28\textwidth]{gfx/colorpalette}
    %\end{center}    
