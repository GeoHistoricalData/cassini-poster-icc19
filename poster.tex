...
\captionof{figure}{GIS-based cartographic visualization of the \og Carte générale \textsc{\textit{\&}} particulière de la France \fg, \textsc{n}\up{o} 52 Clermont en Auvergne. F\up{le} 110: 1759-1777\protect\footnotemark}
 ...
 \includegraphics[width=77cm]{gfx/cassini_52_lr.pdf}
 \label{GIS-based map}
...
\begin{tabular}{l|cccccccc|c|ccc|r}

& \multicolumn{8}{c|}{Landscape feature}
& 
& \multicolumn{3}{c|}{Hydrography}
&\\
...
Area sum (km\up{2})&\num{279}&\num{75}&\num{87}&\num{1368}&\num{142}&\num{0,6}&\num{4}&\num{4}&\num{19}&\num{1,2}&\num{0,8}&\num{1871}&\num{3852}\\
Percent of Map total area&7&2&2&36&4&0&0&0&0&0&0&49&100\\
Linear lenght (km)&-&-&-&-&-&-&-&-&-&-&-&-&-
\end{tabular}
