...
%\switchcolumn
\begin{center}
 \captionof{figure}{Triangulated and Relative Geographical Entities in the 52\up{nd} sheet of the Cassini map (1759-1777)}
...
\begin{minipage}[b]{\textwidth}
  ...
  \begin{multicols}{3}
    ...
    \begin{table}[]
      \begin{center}
      \captionof{table}{Rectangular extent of the map in two coordinate systems : the Cassini projection (planar coordinates in \emph{toises}) and WGS84 (geographical coordinates in degrees).}
      \begin{tabular}{@{}lcccc@{}}
        \toprule
...
%\subsection{Julien}
\footnotesize
\captionof{table}{Areas by land type use, lenght of hydrography and road networks }\label{tab:stats}
...
\begin{center}
 ...
 \label{map:contours}
 \includegraphics[width=0.28\textwidth]{gfx/Contours.png}
 \end{center}
...
\begin{center}
 \captionof{figure}{\scriptsize{(a) view on the original Cassini map of France (sheet 52, 1759-1777) and (b) the extracted vector data mapped with the \og Cassini \fg map style (2019)}}
